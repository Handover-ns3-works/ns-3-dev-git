...
main(int argc, char* argv[])
{
    ...
    lteHelper->SetHandoverAlgorithmAttribute("NeighbourCellOffset", UintegerValue(1));
		...
		// lteHelper->SetFadingModelAttribute("m0", DoubleValue(1));
		// lteHelper->SetFadingModelAttribute("m1", DoubleValue(1));
		// lteHelper->SetFadingModelAttribute("m2", DoubleValue(1));
		// lteHelper->SetPathlossModelType(NakagamiPropagationLossModel::GetTypeId());
		// lteHelper->SetPathlossModelAttribute("m0", DoubleValue(1));
		// lteHelper->SetPathlossModelAttribute("m1", DoubleValue(1));
		// lteHelper->SetPathlossModelAttribute("m2", DoubleValue(1));
