...
def execute_simulation(ttt, hys, speed, angle, q_out, q_in, t_310, n_310, n_311):
	config = f"--timeToTrigger={ttt} --hysteresis={hys} --speed={speed} --angle={angle}--Qout={q_out} --Qin={q_in} --T310={t_310} --N310={n_310} --N311={n_311}"
...
if __name__ == "__main__":
	...
	with ProcessPoolExecutor() as executor:
		...
		for run_values in list(product(ttt, hys, speed, angle, Qout, Qin, T310, N310, N311)):
		...
		try:
			...
			keys_to_include = ['ttt', 'hys', 'speed', 'angle', 'Qout', 'Qin', 'T310', 'N310', 'N311', 'handover_count', 'rlf_count', 'hof_command', 'hof_ttt', 'hof_total']
